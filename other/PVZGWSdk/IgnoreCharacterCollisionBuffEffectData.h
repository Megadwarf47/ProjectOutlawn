...
namespace fb {
	...
	public:
		virtual ClassInfo* getType() const override { return TypeManager::findClass("IgnoreCharacterCollisionBuffEffectData"); }
		virtual ~IgnoreCharacterCollisionBuffEffectData() override {}
		IgnoreCharacterCollisionBuffEffectData() {
