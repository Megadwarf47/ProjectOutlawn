...
namespace fb {
	...
	public:
		virtual ClassInfo* getType() const override { return TypeManager::findClass("NuiSpeechTriggerEntityData"); }
		virtual ~NuiSpeechTriggerEntityData() override {}
		virtual Realm getRealm() const override { return m_realm; }
		NuiSpeechTriggerEntityData() {
