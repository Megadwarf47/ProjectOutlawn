...
namespace fb {
	enum UIHudIcon {
		...
		UIHudIcon_PlantAssault = 159,
		UIHudIcon_PlantDefender = 160,
		UIHudIcon_PlantMedic = 161,
		UIHudIcon_PlantSniper = 162,
		UIHudIcon_ZombieAssault = 163,
		UIHudIcon_ZombieEngineer = 164,
		UIHudIcon_ZombieMedic = 165,
		UIHudIcon_ZombieMaster = 166,
		UIHudIcon_PlantInjured = 167,
		UIHudIcon_PlantCritical = 168,
		UIHudIcon_RevivePlant = 169,
		UIHudIcon_ReviveZombie = 170,
		UIHudIcon_PlantAssault_Large = 171,
		UIHudIcon_PlantDefender_Large = 172,
		UIHudIcon_PlantMedic_Large = 173,
		UIHudIcon_PlantSniper_Large = 174,
		UIHudIcon_HealthCritical = 175,
		UIHudIcon_HealthInjured = 176,
		UIHudIcon_Count = 177
	};
}
