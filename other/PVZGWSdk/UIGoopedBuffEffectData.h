...
namespace fb {
	...
	public:
		virtual ClassInfo* getType() const override { return TypeManager::findClass("UIGoopedBuffEffectData"); }
		virtual ~UIGoopedBuffEffectData() override {}
		UIGoopedBuffEffectData() {
