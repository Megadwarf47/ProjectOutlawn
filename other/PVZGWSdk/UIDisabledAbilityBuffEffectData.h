...
namespace fb {
	...
	public:
		virtual ClassInfo* getType() const override { return TypeManager::findClass("UIDisabledAbilityBuffEffectData"); }
		virtual ~UIDisabledAbilityBuffEffectData() override {}
		UIDisabledAbilityBuffEffectData() {
