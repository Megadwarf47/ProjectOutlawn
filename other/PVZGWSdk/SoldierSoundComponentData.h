...
namespace fb {
	class SoldierSoundComponentData : public GameComponentData {
	public:
		virtual ClassInfo* getType() const override { return TypeManager::findClass("SoldierSoundComponentData"); }
		virtual ~SoldierSoundComponentData() override {}
		...
		SoldierSoundComponentData() {
			...
			m_runPeriod = 0.2f;
			m_antBoneOffset = 0.f;
			m_explosionImpulseMagnitudeThreshold = 100.f;
		};
		...
		float m_explosionImpulseMagnitudeThreshold; // 0x104 (260)
	}; // 0x110 (272)
}
