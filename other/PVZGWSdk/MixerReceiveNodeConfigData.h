...
namespace fb {
	...
	public:
		virtual ClassInfo* getType() const override { return TypeManager::findClass("MixerReceiveNodeConfigData"); }
		virtual ~MixerReceiveNodeConfigData() override {}
		MixerReceiveNodeConfigData() {
		};
