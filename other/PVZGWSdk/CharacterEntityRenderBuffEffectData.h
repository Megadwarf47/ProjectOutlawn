...
namespace fb {
	...
	public:
		virtual ClassInfo* getType() const override { return TypeManager::findClass("CharacterEntityRenderBuffEffectData"); }
		virtual ~CharacterEntityRenderBuffEffectData() override {}
		CharacterEntityRenderBuffEffectData() {
