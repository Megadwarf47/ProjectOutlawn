...
namespace fb {
	class HealthRegenDelayBuffEffectData : public BuffEffectData {
	public:
		virtual ClassInfo* getType() const override { return TypeManager::findClass("HealthRegenDelayBuffEffectData"); }
		virtual ~HealthRegenDelayBuffEffectData() override {}
		HealthRegenDelayBuffEffectData() {
