...
namespace fb {
	class LowPassButterworthNodeData : public AudioGraphNodeData {
	public:
		virtual ClassInfo* getType() const override { return TypeManager::findClass("LowPassButterworthNodeData"); }
		virtual ~LowPassButterworthNodeData() override {}
