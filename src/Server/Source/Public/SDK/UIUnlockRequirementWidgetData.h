...
namespace fb {
	class UIUnlockRequirementWidgetData : public BFUIWidgetEntityData {
	public:
		virtual ClassInfo* getType() const override { return TypeManager::findClass("UIUnlockRequirementWidgetData"); }
		virtual ~UIUnlockRequirementWidgetData() override {}
		UIUnlockRequirementWidgetData() {
		};
