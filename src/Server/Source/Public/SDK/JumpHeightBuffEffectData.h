...
namespace fb {
	...
	public:
		virtual ClassInfo* getType() const override { return TypeManager::findClass("JumpHeightBuffEffectData"); }
		virtual ~JumpHeightBuffEffectData() override {}
		JumpHeightBuffEffectData() {
