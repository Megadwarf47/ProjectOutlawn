...
#define OFFSET_SERVER_CONSTRUCTOR HOOK_OFFSET(0x1406eea10)
#define OFFSET_SERVER_START HOOK_OFFSET(0x1406f8f80)

#define OFFSET_SERVERPLAYER_SETTEAMID HOOK_OFFSET(0x140767A60)
