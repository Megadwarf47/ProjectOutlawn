...
namespace fb {
	class BandPassIir2NodeData : public AudioGraphNodeData {
	public:
		virtual ClassInfo* getType() const override { return TypeManager::findClass("BandPassIir2NodeData"); }
		virtual ~BandPassIir2NodeData() override {}
